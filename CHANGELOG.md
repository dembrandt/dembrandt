...
- Dependencies upgraded: commander 15, ora 9, TypeScript 7, @types/node 26, and the GitHub Actions used by CI. `--help` grouping now uses commander's own item formatter after `Help.wrap` was removed in commander 15; rendered output is unchanged
